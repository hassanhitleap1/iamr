...
<div id="page">
                ...
                <ul>
                    ...
                    <li data-title="FOCUS ON">
                        ...
                        <div class="tp-caption tp-resizeme sl-s3"
                             ...
                             data-responsive_offset="on"
                        ><p>Moving forward you will be paired with a highly vetted, professional awal bookkeeper who will get to know.</p>
                        </div>
                        <!-- LAYER NR. 4 -->
                        ...
                        <!-- LAYER NR. 5 -->
                        <div class="tp-caption"
                             data-x="['center','left','left','left']" data-hoffset="['200','135','135','135']"
                             data-y="bottom" data-voffset="['160','160','200','240']"
                             data-transform_idle="o:1;"
                             data-transform_in="x:100px;opacity:0;s:800;e:Power3.easeOut;"
                             data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;"
    ...
    <section class="bg-quote-h2">
        <div class="quote-inner quote-inner-h2">
            <p>For expert financial advice you can trust <span> Amwal</span></p>
            <a href="#" class="ot-btn btn-sub-color">Get a Quote</a>
        </div>
    </section>
    <!-- /Quote -->
                    ...
                    <div class="col-md-6">
                        <div class="right-whyus-h2">
                            <div class="iconbox-warp ">
                                ...
                                <p class="demo-sub-about-text-2">Temporibus autem quibusdam et aut officiis debitis is aut rerum necessitatibus saepes eveniet ut etes seo lage voluptates repudiandae sint et molestiae non mes  for Creating  futures through building pres preservation. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod incididunt utonis labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p>
                                <div class="iconbox">
                                ...
                                <h3>Personal
                                    <span class="price">
									        	<span class="price-inner">
									        		<span class="big-num">30.</span><span class="small-num">00 $</span>
                        ...
                        <div class="pricing-table pt-most-popular">
                            <div class="plan">
                                <h3>Startup
                                    <span class="price">
									        	<span class="price-inner">
									        		<span class="big-num">60.</span><span class="small-num">00 $</span>
									        		<span class="perm">Per month</span>
									        	</span>
									        </span>
                                </h3>
                        ...
                        <div class="pricing-table">
                            <div class="plan">
                                <h3>Business
                                    <span class="price">
									        	<span class="price-inner">
									        		<span class="big-num">75.</span><span class="small-num">00 $</span>
									        		<span class="perm">Per month</span>
									        	</span>
									        </span>
                                </h3>
    ...
    <section>
        <div class="cb-warp-h2">
            <div class="left-bg-cb-h2 image-container">
                <div class="background-image" style="background: url(images/bg-content/cb-h2.jpg) ;"></div>
            </div>
...
<div id="switcher" >
    ...
    <a href="#" class="ot-btn-classic" style="display: block;">Buy Now</a>
    <div class="div18"></div>
    ...
    <a href="#/" class="reset btn btn-default">
        Default Color
    </a>
</div>
<!-- End Switcher -->