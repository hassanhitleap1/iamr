                      ...
                      <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6 col-lg-offset-4 col-md-8 col-md-offset-2">
                                <label class="radio-inline"><input type="radio" name="optradio"  value="paypal" checked> paypal </label>
                                <label class="radio-inline"><input type="radio" name="optradio" value="western-union">western union </label>
                            </div>
                        </div>
                            ...
                            <?= $form->field($model, 'western_union_full_name')->textInput(['maxlength' => true]) ?>
