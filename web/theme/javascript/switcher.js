...
$(document).ready(function() {
	var e =  '<div class="switcher-container">'+
               ...
               '<div class="selector-box">'+
                    ...
                    '<div class="sw-odd">'+
                    '<div class="sw-image">'+
                        '<a href="https://themeforest.net/item/finance-consulting-accounting-wordpress-theme/19444449">'+
                            '<img src="images/wordpress-version.png" alt="img"/>'+
                        '</a>'+
                        '<button name="button" type="submit" class="sw-buy"><a href="https://themeforest.net/item/finance-consulting-accounting-wordpress-theme/19444449">Buy Now</a></button>'+
