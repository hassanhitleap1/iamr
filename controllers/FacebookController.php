...
class FacebookController extends \yii\base\Controller{
    ...
    // }
      ...
      public  function actionSignupFacebook(){
        ...
        $fb = new Facebook([
        'app_id' => '2008791992709911', // Replace {app-id} with your app id
        'app_secret' => '9f216402f311b0d6e79c280b3191f7d7',
        'default_graph_version' => 'v2.7',
        ]);
        $baseUrl = 'http://localhost/'.Yii::$app->getUrlManager()->getBaseUrl();
        $redirectURL   = 'http://localhost/testsio/web/index.php?r=site/redirect' ;//Callback URL
        $permissions = array('email');  //Optional permissions
        $helper = $fb->getRedirectLoginHelper();
        $loginUrl = $helper->getLoginUrl($redirectURL, $permissions);
